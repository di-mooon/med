    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='static/no_foto.jpg', upload_to='static/', verbose_name='Фото')),
                ('patronymic', models.CharField(max_length=50, verbose_name='Отчество')),
                ('phone', models.CharField(max_length=20, verbose_name='Телефон')),
                ('insurance', models.CharField(blank=True, max_length=20, null=True, verbose_name='Страховой полис')),
                ('date', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('slug', models.SlugField(verbose_name='URL')),
                ('residential_address', models.CharField(blank=True, max_length=250, null=True, verbose_name='Адрес проживания')),
